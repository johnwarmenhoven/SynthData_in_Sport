...
results_df_ex3_nCW$conf.low.resid <- results_df_ex3_nCW$conf.low - t(as.data.frame(rep(final[2,6],nrow(results_df_ex3_nCW))))
results_df_ex3_nCW_s$conf.low.resid <- results_df_ex3_nCW_s$conf.low - t(as.data.frame(rep(final_minus[2,6],nrow(results_df_ex3_nCW_s))))

results_df_ex3_nCW$conf.high.resid <- results_df_ex3_nCW$conf.high - t(as.data.frame(rep(final[2,7],nrow(results_df_ex3_nCW))))
results_df_ex3_nCW_s$conf.high.resid <- results_df_ex3_nCW_s$conf.high - t(as.data.frame(rep(final_minus[2,7],nrow(results_df_ex3_nCW_s))))

results_df_ex3_nCW$estimate.resid <- results_df_ex3_nCW$estimate - t(as.data.frame(rep(final[2,2],nrow(results_df_ex3_nCW))))
results_df_ex3_nCW_s$estimate.resid <- results_df_ex3_nCW_s$estimate - t(as.data.frame(rep(final_minus[2,2],nrow(results_df_ex3_nCW_s))))

## Creating long dataframes for plotting.
results_df_long_ex3_nCW <- gather(results_df_ex3_nCW, key = "variable", value = "value", estimate, conf.low, conf.high)
results_df_long_ex3_nCW_s <- gather(results_df_ex3_nCW_s, key = "variable", value = "value", estimate, conf.low, conf.high)
...
p_below_05_ex3_nCW <- sum(results_df_ex3_nCW$p.value < 0.05) / nrow(results_df_ex3_nCW) * 100
p_below_05_ex3_nCW_s <- sum(results_df_ex3_nCW_s$p.value < 0.05) / nrow(results_df_ex3_nCW_s) * 100
...
p_below_05_err_ex3_nCW <- sqrt((results_df_ex3_nCW$p.value-final$p.value)^2)
p_below_05_err_ex3_nCW <- as.data.frame(p_below_05_err_ex3_nCW)

p_below_05_err_ex3_nCW_s <- sqrt((results_df_ex3_nCW_s$p.value-final$p.value)^2)
p_below_05_err_ex3_nCW_s <- as.data.frame(p_below_05_err_ex3_nCW_s)
...
results_df_ex3_nCW$std.error.resid <- results_df_ex3_nCW$std.error - t(as.data.frame(rep(final[2,3],nrow(results_df_ex3_nCW))))
results_df_ex3_nCW_s$std.error.resid <- results_df_ex3_nCW_s$std.error - t(as.data.frame(rep(final_minus[2,3],nrow(results_df_ex3_nCW_s))))
...
conf.low.abs <- abs(data.frame("conf.low.resid" = results_df_ex3_nCW$conf.low.resid)) 
conf.low.abs_s <- abs(data.frame("conf.low.resid_s" = results_df_ex3_nCW_s$conf.low.resid)) 

conf.high.abs <- abs(data.frame("conf.high.resid" = results_df_ex3_nCW$conf.high.resid)) 
conf.high.abs_s <- abs(data.frame("conf.high.resid_s" = results_df_ex3_nCW_s$conf.high.resid))

estimate.abs <- abs(data.frame("estimate.resid" = results_df_ex3_nCW$estimate.resid)) 
estimate.abs_s <- abs(data.frame("estimate.resid_s" = results_df_ex3_nCW_s$estimate.resid)) 

std.error.abs <- abs(data.frame("std.error.resid" = results_df_ex3_nCW$std.error.resid))
std.error.abs_s <- abs(data.frame("std.error.resid_s" = results_df_ex3_nCW_s$std.error.resid)) 
...
dfs <- list(pMSE_ex3_nCW, 
            s_pMSE_ex3_nCW, 
            PO50_ex3_nCW, 
            time.elapsed_ex3_nCW, 
            AcuteLoad_RMSE_ex3_nCW, 
            ...
            std.error.abs,
            std.error.abs_s,
            p_below_05_err_ex3_nCW,
            p_below_05_err_ex3_nCW_s)
...
library("writexl")
write_xlsx(table,"C:\\Users\\159479\\OneDrive - UTS\\Meta-Research\\2. Synthetic Data\\Experimental Paper\\1. Completed Article & Code\\Results_SC3.xlsx")
