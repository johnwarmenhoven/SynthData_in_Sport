...
results_df_ex7_nCW <- data.frame(matrix(ncol = 7, nrow = 0))
colnames(results_df_ex7_nCW) <- c("term", "estimate", "std.error", "statistic", "p.value", "conf.low", "conf.high")
results_df_ex7_nCW_s <- data.frame(matrix(ncol = 7, nrow = 0))
colnames(results_df_ex7_nCW_s) <- c("term", "estimate", "std.error", "statistic", "p.value", "conf.low", "conf.high")

player1_acute_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 1), nrow = 0))
player4_acute_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 4), nrow = 0))
player7_acute_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 7), nrow = 0))
player11_acute_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 11), nrow = 0))
player15_acute_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 15), nrow = 0))

player1_chronic_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 1), nrow = 0))
player4_chronic_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 4), nrow = 0))
player7_chronic_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 7), nrow = 0))
player11_chronic_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 11), nrow = 0))
player15_chronic_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 15), nrow = 0))

player1_s_chronic_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 1), nrow = 0))
player4_s_chronic_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 4), nrow = 0))
player7_s_chronic_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 7), nrow = 0))
player11_s_chronic_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 11), nrow = 0))
player15_s_chronic_load_ex7_nCW <- data.frame(matrix(ncol = sum(df$PlayerID == 15), nrow = 0))

pMSE_ex7_nCW <- data.frame(matrix(ncol = 1, nrow = 0))
colnames(pMSE_ex7_nCW) <- c("pMSE")
s_pMSE_ex7_nCW <- data.frame(matrix(ncol = 1, nrow = 0))
colnames(s_pMSE_ex7_nCW) <- c("s_pMSE")
PO50_ex7_nCW <- data.frame(matrix(ncol = 1, nrow = 0))
colnames(PO50_ex7_nCW) <- c("PO50")
time.elapsed_ex7_nCW <- data.frame(matrix(ncol = 1, nrow = 0))
colnames(time.elapsed_ex7_nCW) <- c("Time")

AcuteLoad_RMSE_ex7_nCW <- data.frame(matrix(ncol = 1, nrow = 0))
colnames(AcuteLoad_RMSE_ex7_nCW) <- c("RMSE")
ChronicLoad_RMSE_ex7_nCW <- data.frame(matrix(ncol = 1, nrow = 0))
colnames(ChronicLoad_RMSE_ex7_nCW) <- c("RMSE")
ChronicLoad_RMSE_ex7_nCW_s <- data.frame(matrix(ncol = 1, nrow = 0))
colnames(ChronicLoad_RMSE_ex7_nCW_s) <- c("RMSE")
...
for (i in 1:500) {
  ...
  synth.obj <- syn(df, 
                   visit.sequence = c(6, 7, 8, 9, 10, 11, 3, 4, 5),
  ...
  time.elapsed_ex7_nCW[i,] <- end.time - start.time
  time.elapsed_ex7_nCW[i,]
  ...
  player1_acute_load_ex7_nCW[i,] <- player1_data$AcuteLoad
  player4_acute_load_ex7_nCW[i,] <- player4_data$AcuteLoad
  player7_acute_load_ex7_nCW[i,] <- player7_data$AcuteLoad
  player11_acute_load_ex7_nCW[i,] <- player11_data$AcuteLoad
  player15_acute_load_ex7_nCW[i,] <- player15_data$AcuteLoad
  
  # Extract the ChronLoad variable
  player1_chronic_load_ex7_nCW[i,] <- player1_data$ChronicLoad
  player4_chronic_load_ex7_nCW[i,] <- player4_data$ChronicLoad
  player7_chronic_load_ex7_nCW[i,] <- player7_data$ChronicLoad
  player11_chronic_load_ex7_nCW[i,] <- player11_data$ChronicLoad
  player15_chronic_load_ex7_nCW[i,] <- player15_data$ChronicLoad
  
  # Extract the Synthetically derived ChronLoad variables
  player1_s_chronic_load_ex7_nCW[i,] <- player1_data$ChronicLoad_syn
  player4_s_chronic_load_ex7_nCW[i,] <- player4_data$ChronicLoad_syn
  player7_s_chronic_load_ex7_nCW[i,] <- player7_data$ChronicLoad_syn
  player11_s_chronic_load_ex7_nCW[i,] <- player11_data$ChronicLoad_syn
  player15_s_chronic_load_ex7_nCW[i,] <- player15_data$ChronicLoad_syn
  ...
  pMSE_ex7_nCW[i,] <- u1$pMSE
  s_pMSE_ex7_nCW[i,] <- u1$S_pMSE
  PO50_ex7_nCW[i,] <- u1$PO50
  ...
  # Store the result of the second row in the results_df dataframe
  results_df_ex7_nCW_s[i, ] <- final_Syn_Ts[2, ]
  ...
  diff <- na.omit(diff)
  absl <- abs(diff)
  ChronicLoad_RMSE_ex7_nCW_s[i, ] <- mean(absl)
...
results_df_ex7_nCW$conf.low.resid <- results_df_ex7_nCW$conf.low - t(as.data.frame(rep(final[2,6],nrow(results_df_ex7_nCW))))
results_df_ex7_nCW_s$conf.low.resid <- results_df_ex7_nCW_s$conf.low - t(as.data.frame(rep(final_minus[2,6],nrow(results_df_ex7_nCW_s))))

results_df_ex7_nCW$conf.high.resid <- results_df_ex7_nCW$conf.high - t(as.data.frame(rep(final[2,7],nrow(results_df_ex7_nCW))))
results_df_ex7_nCW_s$conf.high.resid <- results_df_ex7_nCW_s$conf.high - t(as.data.frame(rep(final_minus[2,7],nrow(results_df_ex7_nCW_s))))

results_df_ex7_nCW$estimate.resid <- results_df_ex7_nCW$estimate - t(as.data.frame(rep(final[2,2],nrow(results_df_ex7_nCW))))
results_df_ex7_nCW_s$estimate.resid <- results_df_ex7_nCW_s$estimate - t(as.data.frame(rep(final_minus[2,2],nrow(results_df_ex7_nCW_s))))

## Creating long dataframes for plotting.
results_df_long_ex7_nCW <- gather(results_df_ex7_nCW, key = "variable", value = "value", estimate, conf.low, conf.high)
results_df_long_ex7_nCW_s <- gather(results_df_ex7_nCW_s, key = "variable", value = "value", estimate, conf.low, conf.high)
...
p_below_05_ex7_nCW <- sum(results_df_ex7_nCW$p.value < 0.05) / nrow(results_df_ex7_nCW) * 100
p_below_05_ex7_nCW_s <- sum(results_df_ex7_nCW_s$p.value < 0.05) / nrow(results_df_ex7_nCW_s) * 100
...
p_below_05_err_ex7_nCW <- sqrt((results_df_ex7_nCW$p.value-final$p.value)^2)
p_below_05_err_ex7_nCW <- as.data.frame(p_below_05_err_ex7_nCW)

p_below_05_err_ex7_nCW_s <- sqrt((results_df_ex7_nCW_s$p.value-final$p.value)^2)
p_below_05_err_ex7_nCW_s <- as.data.frame(p_below_05_err_ex7_nCW_s)
...
results_df_ex7_nCW$std.error.resid <- results_df_ex7_nCW$std.error - t(as.data.frame(rep(final[2,3],nrow(results_df_ex7_nCW))))
results_df_ex7_nCW_s$std.error.resid <- results_df_ex7_nCW_s$std.error - t(as.data.frame(rep(final_minus[2,3],nrow(results_df_ex7_nCW_s))))
...
conf.low.abs <- abs(data.frame("conf.low.resid" = results_df_ex7_nCW$conf.low.resid)) 
conf.low.abs_s <- abs(data.frame("conf.low.resid_s" = results_df_ex7_nCW_s$conf.low.resid)) 

conf.high.abs <- abs(data.frame("conf.high.resid" = results_df_ex7_nCW$conf.high.resid)) 
conf.high.abs_s <- abs(data.frame("conf.high.resid_s" = results_df_ex7_nCW_s$conf.high.resid))

estimate.abs <- abs(data.frame("estimate.resid" = results_df_ex7_nCW$estimate.resid)) 
estimate.abs_s <- abs(data.frame("estimate.resid_s" = results_df_ex7_nCW_s$estimate.resid)) 

std.error.abs <- abs(data.frame("std.error.resid" = results_df_ex7_nCW$std.error.resid))
std.error.abs_s <- abs(data.frame("std.error.resid_s" = results_df_ex7_nCW_s$std.error.resid)) 
...
dfs <- list(pMSE_ex7_nCW, 
            s_pMSE_ex7_nCW, 
            PO50_ex7_nCW, 
            time.elapsed_ex7_nCW, 
            AcuteLoad_RMSE_ex7_nCW, 
            ChronicLoad_RMSE_ex7_nCW, 
            ChronicLoad_RMSE_ex7_nCW_s,
            conf.low.abs,
            conf.low.abs_s,
            conf.high.abs,
            conf.high.abs_s,
            ...
            std.error.abs,
            std.error.abs_s,
            p_below_05_err_ex7_nCW,
            p_below_05_err_ex7_nCW_s)
...
library("writexl")
write_xlsx(table,"C:\\Users\\159479\\OneDrive - UTS\\Meta-Research\\2. Synthetic Data\\Experimental Paper\\1. Completed Article & Code\\Results_SC7.xlsx")
